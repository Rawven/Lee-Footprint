...
public class b_三角形最小路径和 {
    public static void main(String[] args) {
        ...
        objects.add(new ArrayList<>(){{add(2);}});
        objects.add(new ArrayList<>(){{add(3);add(4);}});
        objects.add(new ArrayList<>(){{add(6);add(5);add(7);}});
        objects.add(new ArrayList<>(){{add(4);add(1);add(8);add(3);}});
